...
ECDSA is a digital signature scheme that uses elliptic curves. If you head over to google.com and click the little green lock next to the url, you'll see that your browser authenticated that page using ECDSA. One of its best known uses is in Bitcoin, where spending money amounts to generating a valid ECDSA signature. Any user able to efficiently forge signatures would become an instant billionaire!
